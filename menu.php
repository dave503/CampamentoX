<div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href=""> <span class="logo-name">CampamentoX</span>
            </a>
          </div>
          <ul class="sidebar-menu">
            <li class="menu-header">Principal</li>
            <li class="dropdown">
              <a href="" class="nav-link"><i data-feather="monitor"></i><span>Datos</span></a>
            </li>
            <li class="dropdown">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a class="nav-link" href="campamento-list.php">Campamentos</a></li>
                <li><a class="nav-link" href="aranceles-list.php">Aranceles</a></li>
